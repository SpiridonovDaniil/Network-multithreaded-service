...
const smsFilename = "simulator/sms.data"
const mmsApiUrl = "http://localhost:8282/mms" // to params
const voiceFilename = "simulator/voice.data"
const emailFilename = "simulator/email.data"
const billingFilename = "simulator/billing.data"
